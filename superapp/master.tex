...
Ogni giocatore della squadra gioca su un tablet diverso. Il gioco necessita di un ulteriore tablet, il \textit{master}, che non verrà utilizzato da nessun giocatore, ma che fornirà informazioni di massima sulla partita in corso e scandirà le partite e le manche di gioco. I quattro tablet su cui effettivamente il gioco prende forma vengono denominati \textit{slave}.

I tablet comunicano per mezzo di una connessione \textit{Bluetooth}. Un disegno di massima delle posizioni dei tablet è fornito in figura \ref{fig:tablet5}.
