...
\item \code{ConncectionAccepted}: questo messaggio viene inviato dal client al server quando il giocatore accetta di giocare;
\item \code{ConncectionClosed}: questo messaggio viene inviato prima di chiudere la connessione;
